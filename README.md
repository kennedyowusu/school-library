...
Clone this [repository](https://github.com/kennedyowusu/school-library) to your desired folder:

```sh
  cd my-folder
  git clone https://github.com/kennedyowusu/school-library.git
  cd Enumerable
```
...
Feel free to check the [issues page](https://github.com/kennedyowusu/school-library/issues).
...
This project is [MIT](https://github.com/kennedyowusu/school-library/blob/main/LICENSE) licensed.
